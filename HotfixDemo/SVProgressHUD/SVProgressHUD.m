...
+ (void)showInfoWithStatus:(NSString*)status {
    [self showWithStatus:@"锆圣诞节阿斯利康的离开"];
...
#pragma mark XLEXTENTION
+ (void)xl_resetState{
    [[self sharedView] install];
}
...
//     return  [XLVisionControl loginWindow];
//    if ([XLVisionControl loginWindow] && [XLVisionControl loginWindow].hidden == false) {
//        return  [XLVisionControl loginWindow];
//    }
#if !defined(SV_APP_EXTENSIONS)
